...
RASTER_BACKGROUND_DISABLED_START = 51 + (7*8) 	;First raster line of main screen, NTSC & PAL = 51

RASTER_BACKGROUND_DISABLED_END = 251 - 8 - (7*8)	;Last raster line of main screen, NTSC & PAL = 250.
...
;Clear text screen and set text color
	jsr cleartextscreen
	lda #1	;text color
	jsr setalltextcolors

	;jsr setcustomcharactersandcolors
...
rasterbars:
	...
	clc
	adc #66  			    ;Adjust to middle of screen
.rasterwait:
...
STATIC_TEXT:
	!text "c-64 code running in dotnet6502 emulator"
