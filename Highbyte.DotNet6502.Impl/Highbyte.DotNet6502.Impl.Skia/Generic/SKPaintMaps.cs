...
/// <summary>
/// Build SKPaint objects for drawing characters with a specified font and color,
/// and for filling background.
/// </summary>
public class SKPaintMaps
{
    ...
    public SKPaintMaps(int textSize, SKTypeface typeFace, Dictionary<byte, SKColor> colorMap)
    {
        ...
        {
            _emulatorColorTextPaint[colorKey] = BuildTextPaint(ColorMap[colorKey], textSize, typeFace);
            _emulatorColorBackgroundPaint[colorKey] = BuildBackgroundPaint(ColorMap[colorKey]);
        }
    }
    ...
    /// <summary>
    /// Color map assuming 16 colors (0-15) used.
    /// </summary>
    /// <returns></returns>
    public static Dictionary<byte, SKColor> ColorMap = new()
    {
