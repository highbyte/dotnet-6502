...
public class GenericComputerAspNetInputHandler : IInputConsumer
{
    ...
    public GenericComputerAspNetInputHandler(GenericComputer genericComputer, EmulatorInputConfig emulatorInputConfig)
    {
    ...
    {
        _inputHandlerContext = (AspNetInputHandlerContext)hostInputState;
    }
