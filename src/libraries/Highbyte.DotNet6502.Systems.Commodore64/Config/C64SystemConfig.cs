...
public partial class C64SystemConfig : ISystemConfig, ISnapshotableConfig
{
    ...
    /// projection of it. All C64 ROMs are published as bare files, so none needs ZIP extraction.
    /// </summary>
    [JsonIgnore]
    ...
    /// to <see cref="RomDownloader"/> yet (Terminal, SilkNet, SadConsole, Blazor WASM). It cannot
    /// express a ZIP-sourced ROM — those hosts would download the archive itself.
    /// </summary>
