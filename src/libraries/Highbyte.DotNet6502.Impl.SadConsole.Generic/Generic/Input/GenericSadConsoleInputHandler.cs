...
public class GenericSadConsoleInputHandler : IInputConsumer
{
    ...
    public GenericSadConsoleInputHandler(GenericComputer genericComputer, EmulatorInputConfig emulatorInputConfig, ILoggerFactory loggerFactory)
    {
    ...
    {
        // SadConsole's Generic input reads keyboard state directly from GameHost; the host input
        // state is unused.
    }
