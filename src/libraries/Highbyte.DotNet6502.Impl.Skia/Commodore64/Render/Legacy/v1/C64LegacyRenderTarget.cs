...
///   
/// </summary>
[DisplayName("Skia legacy v1")]
[HelpText("Renders C64 to a SkiaSharp SKCanvas using pre-calculated character images.\n" +
    "Supports text modes, colors per raster line, fine scroll and sprites.\n" +
    "Draws directly to the canvas each frame.")]
public class C64LegacyRenderTarget : ICustomRenderTarget<PayloadC64>, IDisposable
{
    public string Name => "C64LegacyRenderTarget";
    ...
    public C64LegacyRenderTarget(C64 c64, Func<SKCanvas> getCanvas, bool flush)
    {
        _c64 = c64;
    ...
    {
        // No code to generate a frame. All drawing is done directly via commands to the Skia canvas in DrawFrame().
    }
    ...
    private void DrawEmulatorCharacterOnScreen(
        SKCanvas canvas,
