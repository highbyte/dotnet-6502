...
namespace Highbyte.DotNet6502.Impl.NAudio.WavePlayers.SilkNetOpenAL;

/// <summary>
/// A NAudio WavePlayer that uses OpenAL (OpenAL bindings provided by Silk.NET.OpenAL) to play audio for cross platform desktop support.
