...
public class GenericComputerSilkNetInputHandler : IInputConsumer
{
    ...
    public GenericComputerSilkNetInputHandler(GenericComputer genericComputer, EmulatorInputConfig emulatorInputConfig)
    {
    ...
    {
        _inputHandlerContext = (SilkNetInputHandlerContext)hostInputState;
    }
