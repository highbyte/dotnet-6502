...
public class C64MenuViewModel : ViewModelBase, ISystemMenuContributor
{
    ...
    private readonly Dictionary<string, C64DownloadProgramInfo> _preloadedPrograms = new()
    {
        ...
        {"commando", new C64DownloadProgramInfo("Commando", "https://csdb.dk/release/download.php?id=127100", downloadType: C64DownloadProgramType.D64Zip, keyboardJoystickEnabled: true, keyboardJoystickNumber: 2, requiresBitmap: true, audioEnabled: true)},
