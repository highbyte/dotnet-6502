...
public class C64MenuViewModel : ViewModelBase, ISystemMenuContributor
{
    ...
    private readonly Dictionary<string, C64DownloadProgramInfo> _preloadedPrograms = new()
    {
        ...
        {"commando", new C64DownloadProgramInfo("Commando", "https://csdb.dk/release/download.php?id=127100", downloadType: C64DownloadProgramType.D64Zip, c64Variant: "C64PAL", keyboardJoystickEnabled: true, keyboardJoystickNumber: 2, requiresBitmap: true, audioEnabled: true)},
        ...
        {"demusinterruptus", new C64DownloadProgramInfo("Demus Interruptus", "https://csdb.dk/release/download.php?id=87571", downloadType: C64DownloadProgramType.D64Zip, c64Variant: "C64PAL", audioEnabled: true, requiresPerLineSprites: true, directLoadPRGName: "*")},
        ...
        {"montyontherun", new C64DownloadProgramInfo("Monty on the Run", "https://csdb.dk/release/download.php?id=157961", downloadType: C64DownloadProgramType.D64, c64Variant: "C64PAL", keyboardJoystickEnabled: true, keyboardJoystickNumber: 2, requiresBitmap: true, audioEnabled: true,  directLoadPRGName: "*")},
        {"paradroid", new C64DownloadProgramInfo("Paradroid", "https://csdb.dk/release/download.php?id=229917", downloadType: C64DownloadProgramType.D64, keyboardJoystickEnabled: true, keyboardJoystickNumber: 2, requiresBitmap: true, audioEnabled: true, directLoadPRGName: "*")},
