...
public sealed class Apple2RomPromptService
{
    ...
    public Task<bool> ShowConfigDownloadAcknowledgementAsync(UserControl owner)
        => ShowDownloadPromptAsync(
            ...
            leadText: "You are about to download Apple II ROM files from:",
        ...
        UserControl? owner)
    {
        ...
        {
            Content = Apple2SystemConfig.ROM_SOURCE_INFO_URL,
            Classes = { "link" },
            FontSize = 10,
        ...
        urlButton.Click += (_, _) => SafeAsyncHelper.Execute(() => LaunchUriIfAvailableAsync(owner, Apple2SystemConfig.ROM_SOURCE_INFO_URL));
                ...
                Children =
                {
                    ...
                    new StackPanel
                    {
                        ...
                        Children =
                        {
                            ...
                            new TextBlock
                            {
                                Text = "Own a real Apple II, or otherwise be licensed by Apple to use these ROMs",
                                FontSize = 10,
                                TextWrapping = TextWrapping.Wrap,
        ...
        {
            _logger.LogError(ex, "Failed to show Apple II ROM prompt overlay.");
