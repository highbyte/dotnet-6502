...
public partial class Apple2ConfigDialogView : UserControl
{
    private ILogger? _logger;
    private ILogger Logger => _logger ??= AppLogger.CreateLogger(nameof(Apple2ConfigDialogView));

    private Apple2ConfigDialogViewModel? _previousViewModel;
    private Apple2ConfigDialogViewModel? ViewModel => DataContext as Apple2ConfigDialogViewModel;
    ...
    private void OnRomLicenseAcknowledgementRequested(object? sender, Apple2RomLicenseAcknowledgementEventArgs e)
        => SafeAsyncHelper.Execute(async () =>
        {
            ...
            var romPromptService = serviceProvider.GetRequiredService<Apple2RomPromptService>();
