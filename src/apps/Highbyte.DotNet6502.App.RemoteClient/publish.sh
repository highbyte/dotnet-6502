...
# Publish RemoteClient app as a self-contained, single-file executable
...
PROJECT_FILE="$SCRIPT_DIR/Highbyte.DotNet6502.App.RemoteClient.csproj"
...
echo "Publishing RemoteClient app..."
