...
$ProjectFile = Join-Path $ScriptDir "Highbyte.DotNet6502.App.SadConsole.csproj"
...
Write-Host "Publishing SadConsole app..."
...
# On macOS/Linux, keep native libraries external due to SDL2/MonoGame loading issues
if ($Runtime -like "win-*") {
