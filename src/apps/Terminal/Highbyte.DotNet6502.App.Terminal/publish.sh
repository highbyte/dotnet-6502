...
# Publish Terminal (TUI) host app as a self-contained, single-file executable
...
PROJECT_FILE="$SCRIPT_DIR/Highbyte.DotNet6502.App.Terminal.csproj"
...
echo "Publishing Terminal (TUI) app..."
