...
public class C64MenuConsole : ControlsConsole, ISadConsoleMenuContribution
{
    ...
    private C64InputHandler C64SadConsoleInputHandler => GetInputHandlerOrThrow();
    ...
    ControlsConsole ISadConsoleMenuContribution.Console => this;
    ...
    public Task HandleKeyReleased(Keys key)
    {
        if (key == Keys.F9)
            return ToggleBasicAIAssistant();
    ...
    private C64InputHandler GetInputHandlerOrThrow()
    {
        return _sadConsoleHostApp.CurrentSystemRunner?.System.InputConsumer as C64InputHandler
