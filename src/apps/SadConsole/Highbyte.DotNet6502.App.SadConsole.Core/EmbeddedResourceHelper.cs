...
public static class EmbeddedResourceHelper
{
    ...
    {
        // Convert file path to embedded resource name. The prefix is the assembly name, resolved
        // at runtime — e.g. "Fonts/C64_ROM.font" -> "<assembly-name>.Fonts.C64_ROM.font".
