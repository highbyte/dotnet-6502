...
waitforrefresh:
.loop1: 
	bit SCREEN_CONTROL_REGISTER_1	;Check if bit #7 (the 9:th bit of the scan line) is set, which means we reached line 256 or above
    bpl .loop1
.loop2:
	bit	SCREEN_CONTROL_REGISTER_1	;Check if bit #7 (the 9:th bit of the scan line) is then cleared, which means we reached line 0.
    bmi .loop2
