namespace SadConsoleTest
{
    ...
    public static class Program
    {
        ...
        static void Main()
        {
            ...
            {
                EmulatorScreenConfig = new EmulatorScreenConfig
                {
                ...
                EmulatorInputConfig = new EmulatorInputConfig
                {
            ...
            // Init SadConsole6502Emulator and run!
            var sadConsole6502Emulator = new SadConsole6502Emulator();
            sadConsole6502Emulator.Start(
                prgFileName,
                emulatorMemoryConfig,
                sadConsoleConfig
                );
        }
    }
