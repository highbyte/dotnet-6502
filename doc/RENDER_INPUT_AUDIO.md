...
|                                            | Input:  `Blazor`,`ASP.NET`,`JS interop`     | Input:  `Highbyte.DotNet6502.Impl.AspNet`     | x       | x       |
|                                            | Audio:  `WebAudio API`, `JS interop`        | Audio:  `Highbyte.DotNet6502.Impl.AspNet`     | x       |         |
|                                            |                                             |                                               |         |         |
| `Highbyte.DotNet6502.App.Avalonia.Desktop` | Render: `Avalonia`                          | Render: `Highbyte.DotNet6502.Impl.Avalonia`   | x       | x       |
|                                            | Input:  `Avalonia`,`SDL`                    | Input:  `Highbyte.DotNet6502.Impl.Avalonia`,`Highbyte.DotNet6502.Impl.SilkNet.SDL` | x       | x       |
|                                            | Audio:  `NAudio`,`OpenAL`                   | Audio:  `Highbyte.DotNet6502.Impl.NAudio`     | x       |         |
|                                            |                                             |                                               |         |         |
| `Highbyte.DotNet6502.App.Avalonia.Browser` | Render: `Avalonia`                          | Render: `Highbyte.DotNet6502.Impl.Avalonia`   | x       | x       |
|                                            | Input:  `Avalonia`,`JS interop`             | Input:  `Highbyte.DotNet6502.Impl.Avalonia`,`Highbyte.DotNet6502.Impl.Browser` | x       | x       |
|                                            | Audio:  `NAudio`,`JS interop`               | Audio:  `Highbyte.DotNet6502.Impl.NAudio`     | x       |         |
|                                            |                                             |                                               |         |         |
...
# Library: Highbyte.DotNet6502.Impl.SilkNet.SDL
TODO
