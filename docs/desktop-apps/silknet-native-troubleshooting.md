# SilkNetNative app troubleshooting
...
The app starts but the menu overlay (ImGui) is not rendered correctly. Buttons and Combo boxes are blank with no text. Cannot start an emulator. Not investigated further.

Also exception below occurred at least once at start.
