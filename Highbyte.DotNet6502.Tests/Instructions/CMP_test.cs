...
namespace Highbyte.DotNet6502.Tests.Instructions
{
    public class CMP_test
    {
        ...
        public void CMP_ABS_X_Works()
        {
            ...
            {
                A              = 0x33,
                Instruction    = OpCodeId.CMP_ABS_X,
                FinalValue     = 0x33,
                ExpectedC      = true,
                ExpectedZ      = true,
                ExpectedN      = false,
        ...
        public void CMP_ABS_Y_Works()
        {
            ...
            {
                A              = 0x33,
                Instruction    = OpCodeId.CMP_ABS_Y,
                FinalValue     = 0x33,
                ExpectedC      = true,
                ExpectedZ      = true,
                ExpectedN      = false,
        ...
        public void CMP_IX_IND_Works()
        {
            ...
            {
                A              = 0x33,
                Instruction    = OpCodeId.CMP_IX_IND,
                FinalValue     = 0x33,
                ExpectedC      = true,
                ExpectedZ      = true,
                ExpectedN      = false,
        ...
        public void CMP_IND_IX_Works()
        {
            ...
            {
                A              = 0x33,
                Instruction    = OpCodeId.CMP_IND_IX,
                FinalValue     = 0x33,
                ExpectedC      = true,
                ExpectedZ      = true,
                ExpectedN      = false,
