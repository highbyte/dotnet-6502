...
namespace Highbyte.DotNet6502.Tests.Instructions
{
    public class AND_test
    {
        ...
        public void AND_ABS_X_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.AND_ABS_X,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000010,
                ExpectedCycles = 4
        ...
        public void AND_ABS_Y_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.AND_ABS_Y,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000010,
                ExpectedCycles = 4
        ...
        public void AND_IX_IND_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.AND_IX_IND,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000010,
        ...
        public void AND_IND_IX_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.AND_IND_IX,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000010,
                ExpectedCycles = 5
