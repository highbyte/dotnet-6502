...
namespace Highbyte.DotNet6502.Tests.Instructions
{
    public class LDA_test
    {
        ...
        public void LDA_ABS_X_Works()
        {
            ...
            {
                A              = 0x00,
                Instruction    = OpCodeId.LDA_ABS_X,
                FinalValue     = 0x12,
                ExpectedA      = 0x12,
                ExpectedCycles = 4
            };
        ...
        public void LDA_ABS_Y_Works()
        {
            ...
            {
                A              = 0x00,
                Instruction    = OpCodeId.LDA_ABS_Y,
                FinalValue     = 0x12,
                ExpectedA      = 0x12,
                ExpectedCycles = 4
            };
        ...
        public void LDA_IX_IND_Works()
        {
            ...
            {
                A              = 0x00,
                Instruction    = OpCodeId.LDA_IX_IND,
                FinalValue     = 0x12,
                ExpectedA      = 0x12,
        ...
        public void LDA_IND_IX_Works()
        {
            ...
            {
                A              = 0x00,
                Instruction    = OpCodeId.LDA_IND_IX,
                FinalValue     = 0x12,
                ExpectedA      = 0x12,
                ExpectedCycles = 5
            };
