...
namespace Highbyte.DotNet6502.Tests.Instructions
{
    ...
    {
        [Fact]
        public void ORA_I_Takes_2_Cycles()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_I,
                FinalValue     = 0,
                ExpectedCycles = 2,
            };
        ...
        [Fact]
        public void ORA_I_Does_Correct_Logic_Operation()
        {
            var test = new TestSpec
            {
                Instruction    = OpCodeId.ORA_I,
        ...
        [Fact]
        public void ORA_I_Does_Correct_Logic_Operation2()
        {
            var test = new TestSpec
            {
                Instruction    = OpCodeId.ORA_I,
        ...
        [Fact]
        public void ORA_I_Does_Correct_Logic_Operation3()
        {
            var test = new TestSpec
            {
                Instruction = OpCodeId.ORA_I,
        ...
        [Fact]
        public void ORA_I_Clears_Z_If_Result_Is_Not_0()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_I,
        ...
        [Fact]
        public void ORA_I_Sets_Z_If_Result_Is_0()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_I,
        ...
        [Fact]
        public void ORA_I_Sets_N_If_Result_Is_Negative()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_I,
        ...
        [Fact]
        public void ORA_I_Clears_N_If_Result_Is_Positive()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_I,
        ...
        /// in the ORA_I instruction above, and are used by all addressing modes.
        /// </summary>
        [Fact]
        public void ORA_ZP_Works()
        {

            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ZP,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
        ...
        [Fact]
        public void ORA_ZP_X_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ZP_X,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000111,
                ExpectedCycles = 4
        ...
        /// </summary>
        [Fact]
        public void ORA_ZP_X_Where_ZeroPage_Address_Plus_X_Wraps_Over_Byte_Size_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ZP_X,
        ...
        [Fact]
        public void ORA_ABS_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ABS,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000111,
                ExpectedCycles = 4
        ...
        [Fact]
        public void ORA_ABS_X_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ABS_X,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000111,
                ExpectedCycles = 4
        ...
        [Fact]
        public void ORA_ABS_X_Where_Address_Plus_X_Crosses_Page_Boundary_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ABS_X,
        ...
        [Fact]
        public void ORA_ABS_Y_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ABS_Y,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000111,
                ExpectedCycles = 4
        ...
        [Fact]
        public void ORA_ABS_Y_Where_Address_Plus_Y_Crosses_Page_Boundary_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_ABS_Y,
        ...
        /// </summary>
        [Fact]
        public void ORA_IX_IND_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_IX_IND,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000111,
        ...
        /// </summary>
        [Fact]
        public void ORA_IX_IND_When_ZeroPage_Address_Plus_X_Wraps_Around_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_IX_IND,
        ...
        /// </summary>
        [Fact]
        public void ORA_IND_IX_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_IND_IX,
                A              = 0b00000011,
                FinalValue     = 0b00000110,
                ExpectedA      = 0b00000111,
                ExpectedCycles = 5
        ...
        /// </summary>
        [Fact]
        public void ORA_IND_IX_When_ZeroPage_Address_Vector_Plus_Y_Crosses_Page_Works()
        {
            var test = new TestSpec()
            {
                Instruction    = OpCodeId.ORA_IND_IX,
