...
namespace Highbyte.DotNet6502.Tests.Instructions
{
    ...
    {
        [Fact]
        public void ASL_ACC_Takes_1_Cycle()
        {
            var test = new TestSpec()
            {
                Instruction    = Ins.ASL_ACC,
                ExpectedCycles = 1,
            };
