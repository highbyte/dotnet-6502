...
> _In the `dotnet-6502` emulator there is also a built-in simpler [machine code monitor](https://highbyte.github.io/dotnet-6502/docs/host-apps/console-monitor/overview/) in the emulator itself that can be activated with F12 (or pressing the Monitor button). It has less features than this VS Code extension._
...
Depenencies
- Required: [**`dotnet-6502`**](https://highbyte.github.io/dotnet-6502/docs/host-apps/installation/#install-via-package-manager) emulator Avalonia UI desktop app.
