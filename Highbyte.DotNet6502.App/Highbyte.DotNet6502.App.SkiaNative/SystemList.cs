...
namespace Highbyte.DotNet6502.App.SkiaNative
{
    public class SystemList
    {
        ...
        /// </summary>
        public static HashSet<string> SystemsNames = new();

        static SystemList()
        {
            SystemsNames.Add(C64.SystemName);
            //SystemsNames.Add(GenericComputer.SystemName);
        }
        ...
        public void BuildSystemLookups(C64Config c64Config) //, GenericComputerConfig genericComputerConfig)
        {
            ...
            // Renderers.Add(genericComputer, new GenericSkiaRenderer(genericComputerConfig.Memory.Screen));
            // InputHandlers.Add(genericComputer, new GenericSilkNetInputHandler(genericComputerConfig.Memory.Input));
        }
    }
}